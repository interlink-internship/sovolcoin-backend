...
GENESIS_REWARD_PUBKEY=04D09DE53C6EAD207CE77114EFA9664D64FD0EF8964E109C425179B3793BF4EA058F41E8B386DCEBBA92201CF2CA6784EEFDFF0EE4B938EC66CAAB8E06E2491687
...
case $1 in
    ...
    start)
        ...
        docker_run_node 2 "cd /$COIN_NAME_LOWER ; ./src/${COIN_NAME_LOWER}d -printtoconsole $CHAIN -listen -noconnect -bind=$DOCKER_NETWORK.2 -addnode=$DOCKER_NETWORK.1 -addnode=$DOCKER_NETWORK.3 -addnode=$DOCKER_NETWORK.4 -addnode=$DOCKER_NETWORK.5" &
